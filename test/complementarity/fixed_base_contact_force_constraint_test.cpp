...
class FixedBaseContactForceConstraintTest : public ::testing::Test {
protected:
  virtual void SetUp() {
...
TEST_F(FixedBaseContactForceConstraintTest, isFeasible) {
...
TEST_F(FixedBaseContactForceConstraintTest, computePrimalResidual) {
  SplitSolution s(robot_);
  s.f = Eigen::VectorXd::Random(5*robot_.num_point_contacts()).array().abs();
  s.set_f_3D();
  s.f(4) = 1.1 * std::sqrt((s.f_3D(0)*s.f_3D(0)+s.f_3D(1)*s.f_3D(1))/(mu_*mu_));
...
TEST_F(FixedBaseContactForceConstraintTest, augmentDualResidual) {
  SplitSolution s(robot_);
  s.f = Eigen::VectorXd::Random(5*robot_.num_point_contacts()).array().abs();
  s.set_f_3D();
  s.f(4) = 1.1 * std::sqrt((s.f_3D(0)*s.f_3D(0)+s.f_3D(1)*s.f_3D(1))/(mu_*mu_));
...
TEST_F(FixedBaseContactForceConstraintTest, augmentCondensedHessian) {
  SplitSolution s(robot_);
  s.f = Eigen::VectorXd::Random(5*robot_.num_point_contacts()).array().abs();
  s.set_f_3D();
  s.f(4) = 1.1 * std::sqrt((s.f_3D(0)*s.f_3D(0)+s.f_3D(1)*s.f_3D(1))/(mu_*mu_));
...
TEST_F(FixedBaseContactForceConstraintTest, augmentCondensedResidual) {
  SplitSolution s(robot_);
  s.f = Eigen::VectorXd::Random(5*robot_.num_point_contacts()).array().abs();
  s.set_f_3D();
  s.f(4) = 1.1 * std::sqrt((s.f_3D(0)*s.f_3D(0)+s.f_3D(1)*s.f_3D(1))/(mu_*mu_));
...
TEST_F(FixedBaseContactForceConstraintTest, computeSlackDirection) {
  SplitSolution s(robot_);
  s.f = Eigen::VectorXd::Random(5*robot_.num_point_contacts()).array().abs();
  s.set_f_3D();
  s.f(4) = 1.1 * std::sqrt((s.f_3D(0)*s.f_3D(0)+s.f_3D(1)*s.f_3D(1))/(mu_*mu_));
